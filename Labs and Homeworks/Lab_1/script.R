...
#Выводы: значения параметров λ обратно пропорциональны среднему и стандартному отклонению экспоненциального распределения, графики зависимостей λ от mean и sd для экспоненциального распределения представляют собой экспоненту. sd и mean прямо пропорциональны и имеют прямолинейную зависимость
...
#Полученный график распределения случайной величины не соответствует графику соответствующей функции распределения и не должен, т.к. в 1 случае - распределение случайной величины по экспоненциальному закону, а во втором - функция
