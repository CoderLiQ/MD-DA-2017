---
title: "lab5.1"
author: "Водяный Михаил, РИ-440005"
...
Вывод: 
Удаление выбросов ничего кардинально не поменяло.
Диета С всё так же заметно лучше двух других. Небольшое различие состоит в том, что до удаления выбросов по результатам сравнения диет А и В диета А признавалась немного лучше, чем В (В-А = -0.27), а после удаления выбросов, принадлежащих диете А, диета В стала признаваться лучше (В-А = 0.22). Однако разница с диетой С для обеих этих диет так и осталась примерно равной 2 (в 10 раз больше, чем у них между собой), из чего всё так же следует, что и А, и В в равной степени неэффективны. Таким образом, на общую картину удаление выбросов в данной ситуации повлияло мало.
